...
public class PipelineTriggerPropertyTest {
    ...
    public void pipelineTriggerPropertyTest() throws Exception {
        ...
        preTriggerJob.getBuildersList().add(new Shell("echo parameter:${" + PipelineTriggerProperty.projectNameParameterKey + "}; " + "echo " + this.preTriggerJobName));
        FreeStyleProject postTriggerJob = jenkins.createFreeStyleProject(this.postTriggerJobName);
        postTriggerJob.getBuildersList().add(new Shell("echo parameter:${" + PipelineTriggerProperty.projectNameParameterKey + "};" + "echo " + this.postTriggerJobName));
    ...
    private void checkTriggeredJobs(FreeStyleProject triggeredJob) throws Exception {
        ...
        while (iterator.hasNext()) {
            ...
            if (!(buildLog.contains("parameter:master") || buildLog.contains("parameter:" + this.additionalBranchName))) {
